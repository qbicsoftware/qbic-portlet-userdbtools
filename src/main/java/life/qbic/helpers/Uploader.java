...
import life.qbic.main.MyPortletUI;
...
public class Uploader implements Upload.SucceededListener, Upload.FailedListener, Upload.Receiver {
    ...
    private life.qbic.logging.Logger logger = new Log4j2Logger(Uploader.class);
    ...
    public OutputStream receiveUpload(String filename, String MIMEType) {
        ...
        error = null;
        fileName = filename;
        file = new File(MyPortletUI.tmpFolder + "up_" + filename);
