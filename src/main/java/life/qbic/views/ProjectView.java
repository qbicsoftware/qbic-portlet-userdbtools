...
import life.qbic.main.ProjectFilterDecorator;
import life.qbic.main.ProjectFilterGenerator;
...
public class ProjectView extends VerticalLayout {
    life.qbic.logging.Logger logger = new Log4j2Logger(ProjectView.class);
